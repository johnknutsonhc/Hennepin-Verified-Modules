...
description: Module Specifications for the Hennepin Verified Modules (AVM) program
---

This section documents all the specifications for Hennepin Verified Modules (AVM) and their respective IaC languages.
